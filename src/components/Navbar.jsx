    ...
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="navbar__container">
        ...
        <div className={`navbar__links ${isMobileMenuOpen ? 'active' : ''}`}>
          ...
          <button onClick={() => scrollToSection('episodes')}>
            Episodes
          </button>
        ...
        <div className="navbar__social">
          <a href="https://github.com/yourusername/unsolved-mysteries-fanpage" target="_blank" rel="noopener noreferrer" className="github-link">
